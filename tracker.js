// for use in Scriptable in iOS to create a countdown widget with progress dots and a background image.
// =====================================================================================================
// USER CONFIGURATION
// =====================================================================================================
...
const START_DATE = new Date(2026, 1, 19);  // February 19, 2026
const END_DATE = new Date(2026, 4, 20);    // May 20, 2026
...
// These are optimized for iPhone 16 Pro. You may need to adjust for different devices.
